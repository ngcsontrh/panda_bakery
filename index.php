    ...
    <div id="home" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/images/home-1.jpg" class="d-block bg-bakery" alt="cake-1">
            </div>
            <div class="carousel-item">
                <img src="assets/images/home-2.jpg" class="d-block bg-bakery" alt="cake-2">
            </div>
            <div class="carousel-item">
                <img src="assets/images/home-3.jpg" class="d-block bg-bakery" alt="cake-3">
            </div>
        </div>
    </div>
